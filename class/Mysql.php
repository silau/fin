...
static public function connect($host, $un, $pw){
...
static public function create($db){
  $q="CREATE DATABASE IF NOT EXISTS $db DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci";
  $result=mysql_query($q);
}

static public function drop($db){
  $q="DROP DATABASE $db IF EXISTS";
  $result=mysql_query($q);
}
